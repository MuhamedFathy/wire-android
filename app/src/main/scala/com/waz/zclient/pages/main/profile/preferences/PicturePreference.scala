...
class PicturePreference(context: Context, attrs: AttributeSet, defStyleAttr: Int, defStyleRes: Int) extends Preference(context, attrs, defStyleAttr, defStyleRes) with PreferenceHelper{
  ...
  private val diameter = getContext.getResources.getDimensionPixelSize(R.dimen.pref_account_icon_size)
  val drawable: ImageAssetDrawable = new ImageAssetDrawable(wireImage, ImageAssetDrawable.ScaleType.CenterInside, ImageAssetDrawable.RequestBuilder.Round)
